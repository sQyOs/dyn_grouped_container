...
define(['./utils'], function (utils) {
  ...
  var aboutDefinition = {
    ...
    items: {
      header: {
        label: 'Dyn Grouped Container',
        style: 'header',
        component: 'text'
      },
      paragraph1: {
        label: `This extension will help you to group Qlik objects within a visual container.(dynamically)`,
        component: 'text'
      },
      paragraph2: {
        label: 'This extension was created by Dennis Jaskowiak & modified by Evgeniy Lykov',
        component: 'text',
      },
      paragraph3: {
        label: 'Version: 1.0.1',
